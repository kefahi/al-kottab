...
class TeacherClasses extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('teacher_id, class_id, grade_id, created_at, updated_at, school_year, notes', 'required'),
			array('teacher_id, class_id, grade_id, created_at, updated_at, school_year', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('teacher_id, class_id, grade_id, created_at, updated_at, school_year, notes', 'safe', 'on'=>'search'),
		);
	}
