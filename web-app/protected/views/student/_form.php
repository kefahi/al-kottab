...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'first_name',  array('class'=>'col-lg-1 control-label'  )); ?>
		<div class="col-lg-5">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'second_name',  array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'third_name',  array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'fourth_name',  array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'gender',  array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="form-group">
		<?php 
		echo $form->labelEx($model,'birth_date' , array('class'=>'col-lg-1 control-label'  )  ) ;  ?>
		<div class='col-lg-5' > 
			<?php 
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'birth_location'  ,array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'mobiles' , array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'land_line' , array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'national_id' , array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'national_id_type' ,array('class'=>'col-lg-1 control-label'  )); ?>
		<div class='col-lg-5' >
	...
	<div class="row buttons col-lg-1">
